    ...
    return (
      <div className="Dashboard">
        <header className="Dashboard-header">
          <p>Welcome Trey Swaniawski to your e-wallet</p>
          <div class="Dashbody-body">
            <h5 class="account-balance">
              This is your available account balance: $994.32
            </h5>
          </div>
        </header>
        <Link to="/trans_history">Transaction History</Link>
        <br/>
        <Link to="/trans_form">Transaction Form</Link>
      </div>
    );
  }
